...
/*   Updated: 2026/01/16 23:19:18 by alejandro        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	respecto al eje de la pantalla con la trasformacion de los puntos segun el pitch del jugador, es decir 
	el horizonte real simulado por el pitch del jugador. Cada ambiente usa
	un tipo de calculo diferente.
...
/*
	...
	- Aplica niebla para mezclar el color con el color de niebla basado en la distancia
	- Devuelve el color modificado listo para renderizar
	- Segun las configuraciones de ambiente del juego conseguimos esfectos esteticos
	  diferentes
*/
